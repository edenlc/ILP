...
import uk.ac.ed.inf.aStarSolver.*;
import uk.ac.ed.inf.outPutters.*;
import uk.ac.ed.inf.restHandler.*;
...
/**
 * Still need to remove some testing methods (directly in the code) and add a couple more comments
 * but program is functionally complete.
 */
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            Callable<String> task = () -> {
                ...
                return "Functions executed";
            };

            Future<String> future = executor.submit(task);
            String result = future.get(60, TimeUnit.SECONDS);
        } catch (TimeoutException e){
            System.err.println("Time to execute > 60s, exiting");
        }catch (InterruptedException | ExecutionException e){
            System.err.println("Process interupted");
